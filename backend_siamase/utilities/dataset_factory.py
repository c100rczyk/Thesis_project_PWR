...
from utilities.contrastive_generator import ContrastiveGenerator, SingleGenerator
...
class DatasetFactory:
    ...
    def build_dataset(ds_path, image_size, batch_size, max_iterations, method):
        ...
        elif method == "single_loss":
            generator = SingleGenerator(ds_path, max_iterations)
            output_signature = OutputSignature.single_loss
        return (
